"""
    ...
    Modified by: Tilemachos Pechlivanoglou and Amanda D'Errico
...
# filter the terms
filtered_terms = ['#trump', '#gop', '#china', '#maga', '#fakenews']

# filter the words to get only hashtags
hashtags = words.filter(lambda w: w in filtered_terms)
